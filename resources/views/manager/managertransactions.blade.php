...
<body>    <div class="container">
        ...
        <div class="main" style="width:100%">
            <div class="main-left" style="width:">
                ...
                <table>
                    <tr> 
                        <td class="tr-head">Customer</td>
                        <td class="tr-head">qty ordered</td>
                        <td class="tr-head">total amount</td>
                        <td class="tr-head">date</td>
                        <td class="tr-head">Cashier</td>
            ...
            <div class="main-right" style="" >
                <div class="ordered-info">
                    <div class="table-ordered" style="justify-content:space-between;">
                        <h2 style="color: white; padding:0; margin:0;">Transaction activity</h2 >
                ...
                <div class="order-list-container">
                    <!-- card -->
                       ...
                       <div class="top-row">
                            <p style="padding-bottom:20px; color:gray;">Pendapatan</p>
                            <p style="padding-bottom:20px; color:gray; ">Customer</p>
                            <p style="padding-bottom:20px; color:gray; ">Date</p>
                            
                        </div>
                        <div class="bottom-row">
                            <p style="padding-bottom:15px;">rp 120000</p>
                            <span class="name" style="padding-bottom:15px;">20</span>
                            <span class="name" style="padding-bottom:15px;">24-12-2000</span>
                        </div>
                        <div class="bottom-row">
                            <p style="">Meja B</p>
...
.button-delete:hover {
    ...
    border:0px;
    border-radius:5px;
    width: 150px; /* Ubah ukuran lebar sesuai kebutuhan Anda */
    height: 40px; /* Ubah ukuran tinggi sesuai kebutuhan Anda */
    padding: 5px; /* Menambahkan padding untuk kenyamanan */
