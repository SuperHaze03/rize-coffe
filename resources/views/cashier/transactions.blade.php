            ...
            <div class="main-right">
                ...
                <div class="order-list-container">
                    ...
                    <div class="card-order">
                        <div class="top-row">
                            <p style="">table <span style="color:blue;">01</span></p>
                            <button class="clear-button">clear table</button>
                        </div>
                    ...
                    <!-- endcard -->
                    <p style="border:1px solid #808080"></p>
                    <div class="card-available" style="color:white;">
                        <div class="top-row">
                            <p style="">table <span style="color:blue;">02</span></p>
                        </div>
                        <div class="bottom-row">
                            <p>Available</p>
                        </div>
